...
// --- THE FIX: ADD POINTER EVENTS AUTO ---
const PageWrapper = forwardRef((props, ref) => {
  return (
    <div 
      className="page" 
      ...
      style={{ 
        width: '100%', 
        height: '100%', 
        pointerEvents: 'auto' // Crucial to allow clicking inside the page
      }}
    >
      {props.children}
    </div>
      ...
      <div className="studio-background">
        <div className="book-frame">
          <HTMLFlipBook 
            ...
            maxHeight={1100}
            showCover={true}
            // --- ESSENTIAL SETTINGS FOR INPUTS ---
            disableFlipByClick={true} // Stops clicks from turning pages
            useMouseEvents={true}      // Keep this true for swiping
            mobileScrollSupport={true}
            swipeDistance={30}
            showPageCorners={true} 
            // This prevents the flipbook from catching events on Page 12 inputs
